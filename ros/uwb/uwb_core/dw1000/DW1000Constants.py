...
RF_RXCTRLH_SUB = 0x08
RF_TXCTRL_SUB = 0x0C
LDOTUNE_SUB = 0x30       # LDO voltage tuning (5 bytes), loaded from OTP
    # --
LEN_RF_RXCTRLH = 1
LEN_RF_TXCTRL = 4
LEN_LDOTUNE = 5
    # OTP addresses holding the per-chip LDOTUNE calibration (low/high words).
LDOTUNE_OTP_LOW = 0x04
LDOTUNE_OTP_HIGH = 0x05
...
# Max SYS_STATUS re-read iterations per IRQ service (bounded drain; codex High 3)
IRQ_DRAIN_MAX = 8
